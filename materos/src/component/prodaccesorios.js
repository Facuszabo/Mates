...
function ProductosAccesorios(){
    return(
        ...
        <Link className="link" to={"/accesorio/despolvillador"}><Card className="item" image={mate} name="Despolvillador"></Card></Link>
        <Link className="link" to={"/accesorio/yerberolatas"}><Card className="item" image={mate} name="Yerbero/Azucarero en latitas"></Card></Link>
        <Link className="link" to={"/accesorio/yerberosimil"}><Card className="item" image={mate} name="Yerbero/Azucarero simil cuero"></Card></Link>

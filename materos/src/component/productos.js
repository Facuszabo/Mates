...
import torpacero from '../img/mates/labrado.jpg'
...
function productos(){
    return(
        ...
        <Link className="link" to={"/mates/imperiallabrado"}><Card className="item" image={torpacero} name="Imperial exclusivo"/></Link>
        ...
        <Link className="link" to={"/canasta/cuero100%"}><Card className="item" image={cuero} name="Canasta 100% cuero" /></Link>
        </div>
        </body>
    )
}

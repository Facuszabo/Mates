...
function RosaMetal(){
    return(
        <>
        <Nav/>
        <Productos image={termo} image1={termo1} image2={termo2} name="Stanley Rosa metalizado 1,3Lt" desc="Con menor distancia entre sus paredes internas que garantiza mayor durabilidad.
Con tapón cebador.
